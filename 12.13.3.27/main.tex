...
p_X(k)&=
\begin{cases}
\pr{4^\prime}\pr{4^\prime}=\frac{81}{100} & k=0\\
\pr{4}\pr{4^\prime}+\pr{4^\prime}\pr{4}=\frac{18}{100} & k=1\\
\pr{4}\pr{4}=\frac{1}{100} & k=2
\end{cases}\\
Var(X) &= E(X^2)-\brak{E(X)}^2\\
Var(X)&= \sum k^2p_X(k) - \brak{\sum kp_X(k)}^2\\
&=\brak{0+\frac{18}{100}+4\frac{1}{100}}-\brak{0+\frac{}{}}
\end{align}
\end{document}
