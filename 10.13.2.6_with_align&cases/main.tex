...
\end{figure}\\
\solution\\
Define a random variable X such that,\\ $X=k$ denote the event of arrow resting in region k $$p_X(k) = \text{Probability of the arrow to rest in region }k$$
\begin{align}
p_X(k)&= \frac{\text{Angle covered by region k}}{\text{Total angle}}\\
\therefore p_X(1) &= \frac{90\degree}{360\degree}=\frac{1}{4}\\&=0.25\\
p_X(2)&= \frac{90\degree}{360\degree}=\frac{1}{4}\\&=0.25\\
p_X(3)&= \frac{180\degree}{360\degree}=\frac{1}{2}\\&=0.5\\
\therefore p_X(k) &= 
\begin{cases}
0.25 &  k=1\\
0.25 &  k=2\\
